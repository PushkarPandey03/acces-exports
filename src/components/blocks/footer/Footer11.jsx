        ...
        <div className="row gy-6 gy-lg-0 ms-18" >
          <div className="col-md-4 col-lg-4">
            <div className="widget">
              <img className="mb-4" src="\img\export-logo-trans.png" srcSet="/img/logo-dark@2x.png 2x" alt="" />

              <p className="mb-4">
  © {new Date().getFullYear()} export.net <br className="d-none d-lg-block" />
  All rights reserved.
</p>
          ...
          <div className="col-md-4 col-lg-4 mt-2">
            <div className="widget">
             ...
             <NextLink title="business@export.net" href="mailto:business@export.net" className="link-body" />
              <br /> +91 9637 422525
            </div>
          </div>
